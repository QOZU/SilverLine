...
#[derive(Debug)]
pub struct SilverLineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SilverLineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SilverLine processing");
    
    let mut processor = SilverLineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SilverLineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SilverLineProcessor::new(false);
